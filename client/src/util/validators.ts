...
const VALIDATOR_TYPE_REQUIRE: ValidatorTypes = "REQUIRE";
const VALIDATOR_TYPE_MINLENGTH: ValidatorTypes = "MINLENGTH";
const VALIDATOR_TYPE_MAXLENGTH: ValidatorTypes = "MAXLENGTH";
const VALIDATOR_TYPE_MIN: ValidatorTypes = "MIN";
const VALIDATOR_TYPE_MAX: ValidatorTypes = "MAX";
const VALIDATOR_TYPE_EMAIL: ValidatorTypes = "EMAIL";
const VALIDATOR_TYPE_FILE: ValidatorTypes = "FILE";
